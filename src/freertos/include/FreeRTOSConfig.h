 ...
 */
	...
	#define TASK_ONE_STACK_SIZE		        ( ( unsigned short ) 1000 )	
	#define TASK_TWO_STACK_SIZE		        ( ( unsigned short ) 1000 )
	#define TASK_THREE_STACK_SIZE			( ( unsigned short ) 1500 )	
	...
	/* The following method will not be used. Instead, the "for ever loop" method will be used */
